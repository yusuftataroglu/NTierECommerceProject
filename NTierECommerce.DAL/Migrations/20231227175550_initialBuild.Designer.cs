...
namespace NTierECommerce.DAL.Migrations
{
    ...
    [Migration("20231227175550_initialBuild")]
            ...
            modelBuilder.Entity("NTierECommerce.Entities.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 12, 27, 20, 55, 50, 795, DateTimeKind.Local).AddTicks(5547),
                            CreatedIpAddress = "tanımsız",
                            Description = "Yazlık, kışlık, renkli, renksiz giyim ürünleri",
                            IsActive = true,
                            MasterId = new Guid("72fc4a40-66d6-47ec-8277-0f872a0a67c1"),
                            Status = 0,
                        ...
                        new
                        {
                            ...
                            CreatedComputerName = "tanımsız",
                            CreatedDate = new DateTime(2023, 12, 27, 20, 55, 50, 795, DateTimeKind.Local).AddTicks(5586),
                            CreatedIpAddress = "tanımsız",
                            Description = "Tablet, Telefon, bilgisayar",
                            IsActive = true,
                            MasterId = new Guid("082549eb-1f9e-4001-a20b-05d7f8de1bbf"),
                            Status = 0,
                            UpdatedComputerName = "tanımsız",
                            UpdatedIpAddress = "tanımsız"
                        },
                        new
                        {
                            ...
                            CreatedComputerName = "tanımsız",
                            CreatedDate = new DateTime(2023, 12, 27, 20, 55, 50, 795, DateTimeKind.Local).AddTicks(5588),
                            CreatedIpAddress = "tanımsız",
                            Description = "parfüm, ruj, falan filan",
                            IsActive = true,
                            MasterId = new Guid("43cce2fd-57ec-43cb-9f96-73c2f0bc08ca"),
                            Status = 0,
                            UpdatedComputerName = "tanımsız",
                            UpdatedIpAddress = "tanımsız"
                        });
            ...
            modelBuilder.Entity("NTierECommerce.Entities.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryId = 1,
                            CreatedComputerName = "tanımsız",
                            CreatedDate = new DateTime(2023, 12, 27, 20, 55, 50, 795, DateTimeKind.Local).AddTicks(7115),
                            CreatedIpAddress = "tanımsız",
                            ImagePath = "https://productimages.hepsiburada.net/s/113/550/110000060380106.jpg",
                            IsActive = true,
                            MasterId = new Guid("d7ad5daf-a28a-4682-81a7-d9a96ea8ac1e"),
                        ...
                        new
                        {
                            ...
                            CategoryId = 2,
                            CreatedComputerName = "tanımsız",
                            CreatedDate = new DateTime(2023, 12, 27, 20, 55, 50, 795, DateTimeKind.Local).AddTicks(7137),
                            CreatedIpAddress = "tanımsız",
                            ImagePath = "https://productimages.hepsiburada.net/s/498/550/110000549694124.jpg",
                            IsActive = true,
                            MasterId = new Guid("d778e30f-762d-4491-bba7-a1218fd47862"),
                            ProductName = "Lenovo",
                            Status = 0,
                            UnitPrice = 30000m,
                        ...
                        new
                        {
                            ...
                            CategoryId = 3,
                            CreatedComputerName = "tanımsız",
                            CreatedDate = new DateTime(2023, 12, 27, 20, 55, 50, 795, DateTimeKind.Local).AddTicks(7140),
                            CreatedIpAddress = "tanımsız",
                            ImagePath = "https://productimages.hepsiburada.net/s/416/550/110000445267488.jpg",
                            IsActive = true,
                            MasterId = new Guid("7a262d13-61fc-4d16-84d3-75468ee3efa6"),
                            ProductName = "MAC Ruj",
                            Status = 0,
                            UnitPrice = 2000m,
